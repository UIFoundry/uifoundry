---
title: "Header 4"
description: "Header with dashed border and light background styling with fixed positioning"
category: "blocks"
---
...
The Header_4 block accepts the following props from PayloadCMS:
...
```bash
npx shadcn@latest add @uifoundry/header-4
```
