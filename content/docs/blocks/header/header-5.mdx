---
title: "Header 5"
description: "Header with fixed backdrop blur and solid border bottom"
category: "blocks"
---
...
The Header_5 block accepts the following props from PayloadCMS:
...
```bash
npx shadcn@latest add @uifoundry/header-5
```
