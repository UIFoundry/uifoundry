...
import { BLOCK_GROUP_FAQ, BLOCK_SLUG_FAQ_4 } from "@/registry/default/lib/constants/blocks";
import headerField from "@/registry/default/lib/fields/header/config";

export const FAQ_4_Block: Block = {
	slug: BLOCK_SLUG_FAQ_4,
	admin: {
