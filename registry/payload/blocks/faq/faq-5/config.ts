...
import { BLOCK_GROUP_FAQ, BLOCK_SLUG_FAQ_5 } from "@/registry/default/lib/constants/blocks";
...
export const FAQ_5_Block: Block = {
	slug: BLOCK_SLUG_FAQ_5,
	admin: {
	...
	fields: [
		...
		},
		{
			...
			type: "array",
			label: "Default Expanded Items (by index, starting from 1)",
			minRows: 0,
			maxRows: 10,
