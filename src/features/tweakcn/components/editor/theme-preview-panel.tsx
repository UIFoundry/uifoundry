...
import ShadcnBlocksLogo from "@tweakcn/assets/shadcnblocks.svg";
...
const DemoCards = lazy(() => import("@tweakcn/components/examples/cards"));
const DemoMail = lazy(() => import("@tweakcn/components/examples/mail"));
const DemoDashboard = lazy(() => import("@tweakcn/components/examples/dashboard"));
const DemoPricing = lazy(() => import("@tweakcn/components/examples/pricing/pricing"));
const TypographyDemo = lazy(() => import("@tweakcn/components/examples/typography/typography-demo"));
