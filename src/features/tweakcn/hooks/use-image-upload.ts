import { useToast } from "@tweakcn/components/ui/use-toast";
import { MAX_SVG_FILE_SIZE } from "@tweakcn/lib/constants";
import { PromptImage } from "@tweakcn/types/ai";
import {
  ALLOWED_IMAGE_TYPES,
  optimizeSvgContent,
  validateSvgContent,
} from "@tweakcn/utils/ai/image-upload";
