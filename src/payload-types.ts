...
export interface Pricing_3_Block {
  ...
  config: {
    /**
     * Which tier should show the 'Popular' badge? (0 = first, 1 = second, 2 = third, -1 = none)
     */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "MediaField_select".
 */
export interface MediaFieldSelect<T extends boolean = true> {
  light?: T;
  dark?: T;
}
/**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "FAQ_1_Block_select".
 */
export interface FAQ_1_BlockSelect<T extends boolean = true> {
  header?: T;
  subheader?: T;
  supportLink?: T;
  faq?:
