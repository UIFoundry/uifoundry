...
export const Comparison_8_Block: Block = {
  slug: BLOCK_SLUG_COMPARISON_8,
  interfaceName: "Comparison_8_Block",
  labels: { singular: "Comparison 8", plural: "Comparison 8's" },
  ...
  fields: [
    ...
    { name: "subheading", type: "text", defaultValue: "What you get" },
    {
      name: "columns",
      type: "array",
      minRows: 2,
      ...
      defaultValue: [
        ...
        { name: "Standard", accessorKey: "standard" },
        { name: "Plus", accessorKey: "plus" },
      ],
      fields: [
        { name: "name", type: "text", required: true },
        {
          ...
          type: "text",
          required: true,
          admin: { placeholder: "e.g. standard | plus" },
        },
        {
    ...
    },
    {
      ...
      defaultValue: [{ feature: "Backups", standard: true, plus: true }],
      hooks: {
