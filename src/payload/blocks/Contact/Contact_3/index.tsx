...
import type { Contact_3_Block } from "~/payload-types";

type IconName = Parameters<typeof Icon>[0]["icon"];

export default function Contact_3(props: Contact_3_Block) {
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
          {list.map((m, i) => (
            ...
            >
              {m.icon ? (
                <div className="bg-muted/50 text-muted-foreground mb-3 inline-flex size-9 items-center justify-center rounded-md">
