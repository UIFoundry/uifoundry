...
import type { Features_6_Block } from "~/payload-types";

export default function Features_6(props: Features_6_Block) {
  const [active, setActive] = useState(0);
  const items = Array.isArray(props.tabs) ? props.tabs : [];
