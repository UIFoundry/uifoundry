...
import { Home, Megaphone, Menu, X } from "lucide-react";
...
export default function Header_4({
  ...
  menuItems,
  ...navProps
}: Header_4_Block & ComponentPropsWithRef<"nav">) {
  ...
  return (
    <header>
      {announcement && (
        <div className="bg-muted text-muted-foreground flex items-center justify-center gap-2 px-4 py-2 text-sm">
      ...
      <nav
        ...
        id="header"
        className={cn(
          "bg-background/60 supports-[backdrop-filter]:bg-background/60 sticky top-0 z-20 w-full border-b backdrop-blur",
