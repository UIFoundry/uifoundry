                    ...
                    <div className="relative pt-24 md:pt-36">
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <AnimatedGroup variants={transitionVariants} className={cn((!props.alertLabel || !props.alertLink) && "hidden")}>
                                    <Link
                                        href="#link"
                        ...
                        <AnimatedGroup
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
																{props?.media?.dark && <Image
                                        className={cn("bg-background aspect-15/8 relative hidden rounded-2xl dark:block")}
                                        src={(props.media.dark as Media).url!}
                                        alt={(props.media.dark as Media).alt}
                                        width="2700"
                                        height="1440"
                                    />}
																		{props?.media?.light && <Image
