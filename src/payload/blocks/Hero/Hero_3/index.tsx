					...
					<div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
						...
						<div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row lg:justify-start">
							...
							<Button
								asChild
								size="lg"
								className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full px-8 pl-5 pr-3 text-base shadow-sm shadow-black/20"
							>
							...
							<Button
								...
								variant="ghost"
								size="lg"
								className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full px-8 text-base hover:bg-zinc-950/5 dark:hover:bg-white/5"
							>
