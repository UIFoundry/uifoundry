...
import {
  BLOCK_GROUP_PRICING,
  BLOCK_SLUG_PRICING_10,
} from "~/payload/constants/blocks";

export const Pricing_10_Block: Block = {
  slug: BLOCK_SLUG_PRICING_10,
  interfaceName: "Pricing_10_Block",
  labels: { singular: "Pricing 10", plural: "Pricing 10's" },
