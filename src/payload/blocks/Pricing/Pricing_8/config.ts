...
import {
  BLOCK_GROUP_PRICING,
  BLOCK_SLUG_PRICING_8,
} from "~/payload/constants/blocks";

export const Pricing_8_Block: Block = {
  slug: BLOCK_SLUG_PRICING_8,
  interfaceName: "Pricing_8_Block",
  labels: { singular: "Pricing 8", plural: "Pricing 8's" },
