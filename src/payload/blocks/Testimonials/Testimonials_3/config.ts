...
export const Testimonials_3_Block: Block = {
	...
	fields: [
		{
			...
			fields: [
				...
				subHeaderField({
					defaultValue: "Authentic testimonials from thrilled users who've unlocked game-changing results with our platform.",
				}),
			],
	...
	labels: {
		plural: "Testimonials 3's",
		singular: "Testimonials 3",
	},
};
