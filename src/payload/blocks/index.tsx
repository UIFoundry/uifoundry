...
import { blocks as heroBlocks, blockComponents as heroBlockComponents } from "./Hero"

export const blocks: Block[] = teamsBlocks.concat(featuresBlocks).concat(heroBlocks)
