...
export default $config({
	...
	async run() {
		...
		const NEXT_PUBLIC_STRIPE_FOUNDER_PRICE_ID = new sst.Secret(
			"NEXT_PUBLIC_STRIPE_FOUNDER_PRICE_ID",
		);
		const NEXT_PUBLIC_STRIPE_PIONEER_PRICE_ID = new sst.Secret(
		...
		new sst.aws.Nextjs("Frontend", {
			...
			environment: {
				...
				NEXT_PUBLIC_STRIPE_FOUNDER_PRICE_ID:
					NEXT_PUBLIC_STRIPE_FOUNDER_PRICE_ID.value,
				NEXT_PUBLIC_STRIPE_PIONEER_PRICE_ID:
					NEXT_PUBLIC_STRIPE_PIONEER_PRICE_ID.value,
				NEXT_PUBLIC_STRIPE_EARLY_ADOPTER_PRICE_ID:
					NEXT_PUBLIC_STRIPE_EARLY_ADOPTER_PRICE_ID.value,
